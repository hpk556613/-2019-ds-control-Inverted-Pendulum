...
void oled_show(void)
{
		//=============第1行显示角度PD控制P参数Position_KP=======================//	
		                      ...
		                      OLED_ShowNumber(40,00,Angle_KP,3,12);
	                        OLED_ShowString(57,00,"."),  
	                        OLED_ShowNumber(61,00,(int)(Angle_KP*10)%10,1,12);
	
//	                        OLED_ShowString(95,00,"A:");	  
//	                        OLED_ShowNumber(108,00,Amplitude1,2,12);
		//=============第2行显示角度PD控制D参数=======================//	
		                      OLED_ShowString(00,10,"B-KD");
		                      OLED_ShowNumber(40,10,Angle_KD,3,12);
	                        OLED_ShowString(57,10,"."),  
	                        OLED_ShowNumber(61,10,(int)(Angle_KD*10)%10,1,12);
