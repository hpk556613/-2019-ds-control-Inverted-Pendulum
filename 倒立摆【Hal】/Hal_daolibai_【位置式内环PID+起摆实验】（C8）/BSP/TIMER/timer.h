...
extern __IO int Encoder_Bias;
extern __IO int Encoder_Enter;
extern __IO int Encoder_Last;
...
extern __IO uint16_t timer_coun_1ms;
extern __IO uint16_t timer_count_50ms;
extern __IO uint16_t timer_count_100ms;
extern __IO uint16_t Check_start;
extern __IO uint16_t Check_going;
